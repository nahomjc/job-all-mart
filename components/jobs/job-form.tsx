...
import { submitJobAction, type ActionState } from "@/server/actions/jobs";
  ...
  return (
    <form action={action} className="space-y-6">
      <div className="grid gap-4 md:grid-cols-2">
        <Field label="Job title" name="title" error={state.fieldErrors?.title?.[0]}>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Field label="Category" name="categoryId" error={state.fieldErrors?.categoryId?.[0]}>
        ...
        <Field label="Location" name="location" error={state.fieldErrors?.location?.[0]}>
          <Input name="location" placeholder="Remote / Lagos, NG" required />
        </Field>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Field label="Currency" name="salaryCurrency">
          <Input name="salaryCurrency" defaultValue="USD" maxLength={8} />
        </Field>
      </div>
