	...
	return (
		<div className="relative mx-auto h-[min(560px,72vh)] w-full max-w-[460px] lg:h-[580px] lg:max-w-none">
			...
			<motion.div
				...
				className="pointer-events-none absolute left-1/2 top-1/2 size-[280px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-emerald-400/30 blur-3xl sm:size-[320px]"
			/>
						...
						<div className="overflow-hidden rounded-[1.85rem] bg-[#f4f6f5]">
							...
							<div className="space-y-2 bg-[#f4f6f5] px-3 py-3">
								{[
									...
									>
										<span className="flex size-8 shrink-0 items-center justify-center rounded-lg bg-emerald-100 text-brand-deep">
								...
								<div className="flex gap-2">
									<div className="flex-1 rounded-xl bg-emerald-50 py-2 text-center">
										...
										<p className="text-xs font-bold text-emerald-700">+128</p>
									</div>
			...
			>
				<div className="flex items-center gap-3 rounded-2xl border border-white/40 bg-white px-4 py-3.5 text-foreground shadow-2xl shadow-black/20">
					...
					<div>
						...
						<p className="text-[10px] text-emerald-600">3 steps left</p>
					</div>
				</div>
			</FloatingStat>
			...
			>
				<div className="rounded-2xl border border-emerald-400/30 bg-emerald-950/80 px-4 py-2.5 text-white shadow-xl backdrop-blur">
					<p className="text-[10px] text-emerald-200">Verified posts</p>
